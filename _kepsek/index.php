...
<head>
    ...
    <title>E-Jurnal || Page Kepalasekolah</title>
                ...
                <ul class="nav navbar-nav">
                    <li> <br>
                       <!--  <a href="index.html"> <i class="menu-icon fa fa-dashboard"></i>Dashboard </a> -->
                           <center>
                    	<img src="../images/<?php echo $data['photok']; ?>" class="img-responsive" style=" border:2px dashed silver; border-radius:100%; height: 80px;width: 80px;">
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="../images/<?php echo $data['photok']; ?>" alt="User Avatar">
                        </a>
            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1> <span class="fa fa-home"></span> Halaman Kepala Sekolah</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                ...
                <div class="col-md-12"> 
                    ...
                    <!-- Script Content -->
                        ...
                        if ($page=='act') {
                         ...
                         }elseif ($page=='lihatini') {
                            include 'kegiatan-detail.php';
                         }elseif ($page=='') {
