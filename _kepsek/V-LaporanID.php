...
<table id="bootstrap-data-table" class="table table-responsive">
    <thead>
      <tr>
        <th>No.</th>
        <th>NUPTK</th> 
        <th>Nama Guru</th> 
        <th>Kelas/Jur</th> 
        <th> <span class="fa fa-calendar"></span> Agenda / Mata Pelajaran</th>  
      ...
      <tr>
        ...
        <td>
          ...
          while ($dm = mysqli_fetch_array($mapel)) {
            ...
            echo "<a href='?page=v_mapelagenda& idg= $dm[id_mapel] '><b> " .$dm['kelas']. "</b> </a>"."<br>";
         ...
         <td>
          ...
          while ($dm = mysqli_fetch_array($mapel)) {
            echo "<span class='badge badge-primary'>".$n++.".</span>";
             ...
             echo "<a href='?page=v_mapelagenda& idg= $dm[id_mapel] 'style='color:#2979ff;border-bottom:2px;'><b> " .$dm['nama_mapel']. "</b> </a>"."<br>";
          ...
          while ($dm = mysqli_fetch_array($mapel)) {
            echo "<span class='badge badge-primary'>".$n++.".</span>";
             ...
             echo "<a href='?page=v_filemapel& idg= $dm[id_mapel] 'style='color:#2979ff;border-bottom:2px;'><b> " .$dm['nama_mapel']. "</b> </a>"."<br>";
          ...
          <td>
              <a href="?page=v_aglain&idg=<?php echo $data['id_guru']; ?> " title="Lihat Agenda Lainnya" class="btn btn-danger" style="border-top-right-radius: 20px; background-color:#f50057;border:none;"> <span class="fa fa-calendar"></span> Agenda Lain</a>
        </td>
      </tr>
      <?php 
       }
