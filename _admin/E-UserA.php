<div class="col-md-4">
                        <section class="card">
                            <div class="twt-feed blue-bg">
                             ...
                             <?php 
                             $id = $_GET['id'];
                             $sql = mysqli_query($con,"SELECT * FROM tb_user WHERE id_admin='$id' ");
                    ...
                    <div class="col-md-8">
                      ...
                      <div class="card-body card-block">
                        <form action="?page=act" method="post" class="">
                          <div class="form-group">
                          	...
                          	<input type="hidden" id="nf-email" name="id" class="form-control" value=" <?php echo $data['id_admin']; ?> ">
                      ...
                      <div class="card-footer">
                        <button type="submit" name="EuserA" class="btn btn-primary btn-sm">
